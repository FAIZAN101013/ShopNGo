            ...
            <div>
                ...
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="flex items-center gap-3">
                            ...
                            <a href="tel:+918805910192" className="text-gray-600 hover:text-black transition-colors text-sm">
                                +91-8805910192
                            </a>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            <a href="mailto:faizan.m.patel10@gmail.com" className="text-gray-600 hover:text-black transition-colors text-sm">
                ...
                <div className="border-t border-gray-200 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-gray-600 text-sm text-center md:text-left">
                        © {new Date().getFullYear()} ShopNGo. Built by Mohammed Faizan Patel.
                    </p>
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex gap-2">
                            {['VISA', 'Mastercard', 'PayPal', 'UPI'].map((method) => (
                                <span
                                    key={method}
                                    className="rounded border border-gray-200 px-2 py-1 text-[10px] font-medium tracking-wide text-gray-500"
                                >
                                    {method}
                                </span>
                            ))}

...
import { verifyRazorpay } from "./config/razorpay.js";
...
verifyRazorpay(); // and say which payment key is loaded, test or live

const app = express(); // this the main this what creates and starts the app

/*
  The payment webhook first, before express.json().

  Its signature covers the exact bytes the provider sent, so that one route
